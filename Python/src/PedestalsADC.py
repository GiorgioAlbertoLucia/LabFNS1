...
hFrame = cCh10noinp.DrawFrame(200,0.,450,0.65,"ADC Pedestals Ch 10 no input; Channel; Counts")
...
hFrame = cCh11NoInp.DrawFrame(200,0.,500,0.7,"ADC Pedestals Ch 11 no input; Channel; Counts")
...
hFrame = cCh10Inp.DrawFrame(150,0.,500,0.1,"ADC Pedestals Ch 10 input S1; Channel; Counts")
...
hFrame = cCh11Inp.DrawFrame(190,0.,520,0.07,"ADC Pedestals Ch 11 input SG; Channel; Counts")
...
hFrame = cCh10Ch11SixNoInp.DrawFrame(235,0.,275,0.7,"ADC Pedestals no inputs 6 #mus; Channel; Counts")
SetObjectStyle(hCh10pedSix,color=kAzure+3,fillalpha=0.9,linewidth=1)
hCh10pedSix.Draw("hist,same")
SetObjectStyle(hCh11pedSix,color=kRed,fillalpha=0.5,linewidth=1)
hCh11pedSix.Draw("hist,same")
leg1 = TLegend(0.45, 0.65, 0.65, 0.75)
leg1.SetTextFont(42)
leg1.SetTextSize(gStyle.GetTextSize()*0.7)
leg1.SetFillStyle(0)
leg1.AddEntry(hCh10pedSix, 'Ch 10', 'lf')
leg1.AddEntry(hCh11pedSix, 'Ch 11', 'lf')
text2 = TLatex(0.46, 0.77,"Pedestals run")
text2.SetNDC()
text2.SetTextSize(gStyle.GetTextSize())
text2.SetTextFont(42)
text = TLatex(0.46, 0.6,"Using 2249W ADC")
text.SetNDC()
text.SetTextSize(gStyle.GetTextSize()*0.7)
text.SetTextFont(42)
text3 = TLatex(0.46, 0.55,"Gate width = (6.0 #pm 0.3) #mus")
text3.SetNDC()
...
hFrame = cCh10Ch11TenNoInp.DrawFrame(390,0.,455,0.55,"ADC Pedestals Ch 10 - Ch 11 no input 10 #mus; Channel; Counts")
...
hFrame = cCh10SixBoth.DrawFrame(190,0.,300,0.7,"ADC Pedestals Ch 10 6 gate #mus; Channel; Counts")
SetObjectStyle(hCh10pedSix,color=kAzure+3,fillalpha=0.9,linewidth=1)
...
hFrame = cCh10TenBoth.DrawFrame(320,0.,480,0.6,"ADC Pedestals Ch 10 gate 10 #mus; Channel; Counts")
SetObjectStyle(hCh10pedTen,color=kAzure+3,fillalpha=0.9,linewidth=1)
SetObjectStyle(hCh10pedInpTen,color=kRed,fillalpha=0.5,linewidth=1)
...
hFrame = cCh11SixBoth.DrawFrame(200,0.,340,0.7,"ADC Pedestals Ch 11 gate input 6 #mus; Channel; Counts")
SetObjectStyle(hCh11pedSix,color=kAzure+3,fillalpha=0.9,linewidth=1)
...
hFrame = cCh11TenBoth.DrawFrame(320,0.,510,0.55,"ADC Pedestals Ch 11 gate input 10 #mus; Channel; Counts")
