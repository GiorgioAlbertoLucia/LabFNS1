...
hFrame = cCh10noinp.DrawFrame(150,0.0001,450,0.7,"Pedestals Ch 10 no input; Channel; Counts")
...
hFrame = cCh10Inp.DrawFrame(150,0.,550,0.2,"Pedestals Ch 10 input S_{1}; Channel; Counts")
...
hFrame = cCh10Ch11SixNoInp.DrawFrame(tNoInpSix["Module4_10"].min()*0.7,0.0001,tNoInpSix["Module4_11"].max()*1.3,1.,"Pedestals Ch 10 - Ch 11 no input 6 #mus; Channel; Counts")
SetObjectStyle(hCh10pedSix,color=kAzure+3,fillalpha=0.9,linewidth=1)
hCh10pedSix.Draw("hist,same")
...
hFrame = cCh10Ch11TenNoInp.DrawFrame(tNoInpTen["Module4_10"].min()*0.7,0.0001,tNoInpTen["Module4_11"].max()*1.3,1.,"Pedestals Ch 10 - Ch 11 no input 10 #mus; Channel; Counts")
...
hFrame = cCh10SixBoth.DrawFrame(tInpSix["Module4_10"].min()*0.7,0.0001,tNoInpSix["Module4_10"].max()*1.3,1.,"Pedestals Ch 10 6 gate #mus; Channel; Counts")
SetObjectStyle(hCh10pedSix,color=kAzure+3,fillalpha=0.9,linewidth=1)
hCh10pedSix.Draw("hist,same")
...
hFrame = cCh10TenBoth.DrawFrame(tInpTen["Module4_10"].min()*0.7,0.0001,tNoInpTen["Module4_10"].max()*1.3,1.,"Pedestals Ch 10 gate 10 #mus; Channel; Counts")
SetObjectStyle(hCh10pedTen,color=kAzure+3,fillalpha=0.9,linewidth=1)
hCh10pedTen.Draw("hist,same")
SetObjectStyle(hCh10pedInpTen,color=kRed,fillalpha=0.5,linewidth=1)
hCh10pedInpTen.Draw("hist,same")
...
hFrame = cCh11SixBoth.DrawFrame(tInpSix["Module4_11"].min()*0.7,0.0001,tNoInpSix["Module4_11"].max()*1.3,1.,"Pedestals Ch 11 gate input 6 #mus; Channel; Counts")
SetObjectStyle(hCh11pedSix,color=kAzure+3,fillalpha=0.9,linewidth=1)
hCh11pedSix.Draw("hist,same")
...
hFrame = cCh11TenBoth.DrawFrame(tInpTen["Module4_11"].min()*0.7,0.0001,tNoInpTen["Module4_11"].max()*1.3,1.,"Pedestals Ch 11 gate input 10 #mus; Channel; Counts")
